...
3.  The contrast checker will tell you whether it meets AA and AAA standards for normal and large text, and for graphical objects and user interface components.
