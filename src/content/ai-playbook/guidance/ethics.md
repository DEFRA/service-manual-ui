...
Follow GDPR and government data handling rules at all times. Do not enter sensitive, personal, or classified data into public AI tools. Use only approved tools that meet Defra's security standards. See [Information governance](/ai-playbook/guidance/information-governance) and [PII and data handling](/ai-playbook/guidance/pii-and-data-handling).
...
3. **Am I prepared to accept responsibility?** If something goes wrong, you must own the consequences.
