...
- [Polished AI code can hide problems](/ai-playbook/lessons-learned/code-quality): review AI output for maintainability, not just correctness.
- [Set clear rules to avoid shadow IT](/ai-playbook/lessons-learned/governance): without clear governance, teams use unapproved tools.
- [Always validate AI outputs](/ai-playbook/lessons-learned/output-validation): well-designed AI content can hide inaccurate data.
