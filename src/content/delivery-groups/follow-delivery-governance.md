...
- work in partnership with business areas to build confidence and trust
- support the full end to end of service delivery, from policy to operations and from conception to live

Policy teams set the outcomes we want to achieve. Operational teams run the services that deliver those outcomes day to day. Delivery groups provide multidisciplinary digital teams to design, build and continuously improve those services.

<span id="how-delivery-groups-work"></span>

## How delivery groups work

Delivery groups are designed to support fast learning, safe decision making and continuous improvement. The delivery group [governance model](https://defra.github.io/delivery-group-governance/governance-model/) defines how each level and function supports a delivery group.
...
A delivery group is primarily made up of digital professionals. Roles are described in the [Government Digital and Data Profession Capability Framework (GDAD)](https://ddat-capability-framework.service.gov.uk/).
...
Everyone should feel happy and supported at work. People should feel like they are actively contributing to outcomes as part of their team.
...
Decisions should be made at the most appropriate level across the delivery group. This is detailed in [the governance model](https://defra.github.io/delivery-group-governance/governance-model/). This means:
...
[Assurance](https://defra.github.io/delivery-group-governance/assurance/) helps delivery groups spot problems early and act on them quicker. It builds confidence that the delivery group is moving in the right direction.
...
Transactional services are measured against [the service standard](https://www.gov.uk/service-manual/service-standard).
