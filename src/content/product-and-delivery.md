...
description: 'Lead the vision, roadmap and day-to-day delivery of services.'
layout: section
...
supportBox:
  title: Get support
  description: >-
    The <strong>Product Community</strong> and <strong>Delivery Management
    Community</strong> can help you understand these standards.<br><br>Let them
    know if you work at Defra through resource augmentation or with a supplier.
    They will add you to the relevant community.
  items:
    - >-
      Product management email: <a href="mailto:product.management@defra.gov.uk"
      class="govuk-link">product.management@defra.gov.uk</a>
    - >-
      Delivery management email: <a
      href="mailto:delivery.management@defra.gov.uk"
      class="govuk-link">delivery.management@defra.gov.uk</a>
---
