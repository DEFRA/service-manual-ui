...
description: >-
  How to give your AI assistant the project context it needs. Conventions for
  Copilot, Cursor, Claude Code and Windsurf.
layout: section
...
supportBox:
  ...
  items:
    - >-
      Email: <a
      href="mailto:AICapabilityAndEnablement@defra.gov.uk?subject=Help%20with%20rules%20for%20AI"
