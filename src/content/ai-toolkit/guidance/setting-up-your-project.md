...
caption: Get started
description: >-
  Install your AI assistant, turn on privacy settings, and add the rules and
  instructions your repo needs.
layout: section
...
supportBox:
  ...
  items:
    - >-
      Email: <a
      href="mailto:AICapabilityAndEnablement@defra.gov.uk?subject=Help%20setting%20up%20my%20project"
