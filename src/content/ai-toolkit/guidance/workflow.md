...
description: >-
  From idea to deployed code, with AI in the loop. A structured workflow that
  keeps quality high.
layout: section
...
supportBox:
  ...
  items:
    - >-
      Email: <a
      href="mailto:AICapabilityAndEnablement@defra.gov.uk?subject=Help%20with%20the%20AI%20workflow"
...
Identify the problem you want to solve and the outcome you need. Write this down clearly before touching any code. See [Generating requirements](/ai-toolkit/guidance/generating-requirements) for how to use AI to expand a feature description into a full specification.
...
Write prompts based on your requirements and let the AI produce code. Keep each prompt focused on a single function or component. See [Feature development with AI](/ai-toolkit/guidance/feature-development).
