...
breadcrumbItems:
  ...
  - text: Report an AI incident
supportBox:
  title: Ask AICE about AI risk
  description: Not sure whether something counts as an incident? Ask us. It is always better to check.
  items:
...
<div class="govuk-warning-text">
  ...
  <strong class="govuk-warning-text__text">
    ...
    Report first, investigate after. Do not wait until you are sure.
  </strong>
</div>
...
<li>shared AI-generated output that contained sensitive or incorrect information about real people or systems</li>
</ul>
