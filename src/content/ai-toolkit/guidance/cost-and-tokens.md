...
description: >-
  Real cost ranges from Defra teams using AI in delivery. How tokens work, what
  affects the bill, and how to keep it under control.
layout: section
...
supportBox:
  ...
  items:
    - >-
      Email: <a
      href="mailto:AICapabilityAndEnablement@defra.gov.uk?subject=Cost%20and%20tokens"
