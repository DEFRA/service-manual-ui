...
description: >-
  OFFICIAL classification only. How AI tools route data, and what to do if you
  are unsure.
layout: section
...
supportBox:
  ...
  items:
    - >-
      Email: <a
      href="mailto:AICapabilityAndEnablement@defra.gov.uk?subject=Information%20governance%20enquiry"
