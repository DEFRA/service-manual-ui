...
<div class="govuk-inset-text">
  <p class="govuk-body govuk-!-margin-bottom-0">What you can put into Bedrock depends on your data's classification and how it is set up. Check <a class="govuk-link" href="/ai-toolkit/guidance/using-data-with-ai">Using data with AI</a> before you use it.</p>
</div>
...
- enterprise controls such as private networking, IAM, logging and guardrails
