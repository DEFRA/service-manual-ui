...
caption: Tools
description: >-
  AI pair programmer that suggests code as you type. Endorsed for use across
  Defra delivery teams.
layout: section
...
supportBox:
  ...
  description: >-
    Ask the AI Capability and Enablement team about setup, security or how to
    get the most out of it.
  items:
    - >-
      Email: <a
      href="mailto:AICapabilityAndEnablement@defra.gov.uk?subject=Help%20with%20GitHub%20Copilot"
