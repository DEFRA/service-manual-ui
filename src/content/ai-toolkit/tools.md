...
<li class="app-radar-card" data-status="endorse" data-category="tool" data-name="github copilot">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/github-copilot" class="govuk-link app-radar-card__link">GitHub Copilot</a></h3>
...
<li class="app-radar-card" data-status="pilot" data-category="platform" data-name="aws bedrock">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/aws-bedrock" class="govuk-link app-radar-card__link">AWS Bedrock</a></h3>
...
<li class="app-radar-card" data-status="pilot" data-category="platform" data-name="azure ai foundry">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/azure-ai-foundry" class="govuk-link app-radar-card__link">Azure AI Foundry</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="framework" data-name="model context protocol mcp">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/model-context-protocol" class="govuk-link app-radar-card__link">Model Context Protocol (MCP)</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="framework" data-name="agent to agent a2a">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/agent-to-agent" class="govuk-link app-radar-card__link">Agent-to-Agent (A2A)</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="framework" data-name="langgraph">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/langgraph" class="govuk-link app-radar-card__link">LangGraph</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="framework" data-name="retrieval augmented generation rag">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/retrieval-augmented-generation" class="govuk-link app-radar-card__link">Retrieval-augmented generation (RAG)</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="platform" data-name="langfuse">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/langfuse" class="govuk-link app-radar-card__link">Langfuse</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="platform" data-name="aws bedrock agentcore">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/aws-bedrock-agentcore" class="govuk-link app-radar-card__link">AWS Bedrock AgentCore</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="tool" data-name="claude code plugin marketplace">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/claude-code-marketplace" class="govuk-link app-radar-card__link">Claude Code plugin marketplace</a></h3>
...
<li class="app-radar-card" data-status="assess" data-category="tool" data-name="git ai">
  ...
  <h3 class="app-radar-card__title"><a href="/ai-toolkit/tools/git-ai" class="govuk-link app-radar-card__link">Git AI</a></h3>
