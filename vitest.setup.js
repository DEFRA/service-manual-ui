...
process.env.NOTIFY_API_KEY = process.env.NOTIFY_API_KEY || 'dummy-api-key-for-tests'
process.env.NOTIFY_TRIAGE_TEMPLATE_ID = process.env.NOTIFY_TRIAGE_TEMPLATE_ID || 'dummy-template-id-for-tests'
