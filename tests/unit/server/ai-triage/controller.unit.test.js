...
vi.mock('../../../../src/server/ai-triage/session.js', () => ({
...
vi.mock('../../../../src/server/ai-triage/model.js', () => ({
  TriageSubmission: {
...
vi.mock('../../../../src/server/ai-triage/service.js', () => ({
...
const {
  ...
  postSummaryPage,
  getThankYouPage
} = await import('../../../../src/server/ai-triage/controller.js')
