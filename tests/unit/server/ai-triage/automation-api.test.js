...
import { composeSubmissionText, postSubmission } from '../../../../src/server/ai-triage/automation-api.js'

vi.mock('../../../../src/server/ai-triage/automation-token.js', () => ({
  getToken: vi.fn()
}))

const { getToken } = await import('../../../../src/server/ai-triage/automation-token.js')
