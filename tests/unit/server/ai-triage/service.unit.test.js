...
vi.mock('../../../../src/server/ai-triage/automation-api.js', () => ({
  postSubmission: vi.fn()
}))

const { postSubmission } = await import('../../../../src/server/ai-triage/automation-api.js')
const { submit } = await import('../../../../src/server/ai-triage/service.js')
